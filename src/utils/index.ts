...
export const setCssVar = (prop: string, val, dom = document.documentElement) => {
 ...
 * @return 格式化后的数量
 */
export const erpCountTableColumnFormatter = (cellValue) => {
 ...
 * @return 格式化后的数量
 */
export const erpPriceTableColumnFormatter = (cellValue) => {
...
export function jsonParse(str: string) {
  try {
    ...
    console.error(`str[${str}] 不是一个 JSON 字符串`, e)
    return ''
  }
}
// 生成签名
