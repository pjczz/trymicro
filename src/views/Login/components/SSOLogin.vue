  ...
  <div v-show="ssoVisible" class="form-cont">
    ...
    <div>
      <el-form :model="formData" class="login-form">
        <!-- 授权范围的选择 -->
        此第三方应用请求获得以下权限：
        <el-form-item name="scopes">
          <el-checkbox-group v-model:value="formData.scopes">
            <el-checkbox
        ...
        <el-form-item class="w-1/1">
          <el-button :loading="formLoading" class="w-6/10" type="primary" @click.prevent="handleAuthorize(true)">
...
import { watch, ref, computed, reactive, unref } from 'vue'
